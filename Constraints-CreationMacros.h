...
#define ALIGN_H(VIEW, INDENT)             {ALIGN_LEFT(VIEW, INDENT); ALIGN_RIGHT(VIEW, INDENT);}
#define ALIGN_V(VIEW, INDENT)             {ALIGN_TOP(VIEW, INDENT); ALIGN_BOTTOM(VIEW, INDENT);}
...
#define ALIGN_PAIR_ALL(VIEW1, VIEW2)        {ALIGN_PAIR_BOTTOM(VIEW1, VIEW2); ALIGN_PAIR_LEFT(VIEW1, VIEW2); ALIGN_PAIR_TOP(VIEW1, VIEW2); ALIGN_PAIR_RIGHT(VIEW1, VIEW2);}
...
#define ALIGN_PAIR_LEFT_TO(VIEW1, VIEW2, INDENT)       INSTALL_CONSTRAINTS(DEFAULT_LAYOUT_PRIORITY, @"Align Pair", CONSTRAINT_ALIGNING_PAIR_LEFT(VIEW1, VIEW2, INDENT))
#define ALIGN_PAIR_RIGHT_TO(VIEW1, VIEW2, INDENT)      INSTALL_CONSTRAINTS(DEFAULT_LAYOUT_PRIORITY, @"Align Pair", CONSTRAINT_ALIGNING_PAIR_RIGHT(VIEW1, VIEW2, INDENT))
#define ALIGN_PAIR_TOP_TO(VIEW1, VIEW2, INDENT)        INSTALL_CONSTRAINTS(DEFAULT_LAYOUT_PRIORITY, @"Align Pair", CONSTRAINT_ALIGNING_PAIR_TOP(VIEW1, VIEW2, INDENT))
#define ALIGN_PAIR_BOTTOM_TO(VIEW1, VIEW2, INDENT)     INSTALL_CONSTRAINTS(DEFAULT_LAYOUT_PRIORITY, @"Align Pair", CONSTRAINT_ALIGNING_PAIR_BOTTOM(VIEW1, VIEW2, INDENT))
